...
export default function SideBar() {
    ...
    return <Fragment>
        <nav className="bg-white sidebar shadow-2xl gap-y-4 rounded-r-3xl flex py-8 pl-2  flex-col justify-between max-md:w-max md:w-[10rem] h-[calc(100vh-5rem)] ">
            <div className="flex gap-y-6 flex-col w-full">
                <NavItem uri="/admin/dashboard/index" >
                ...
                <NavItem uri="posts"
                    ...
                    <span className="max-md:hidden">Posts</span>
                </NavItem>
